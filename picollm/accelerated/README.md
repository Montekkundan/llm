...
- `python -m picollm.accelerated.pretrain.train --depth=24 --target-param-data-ratio=8 --device-batch-size=2 --total-batch-size=131072`
- `python -m picollm.accelerated.pretrain.eval --device-batch-size=2`
- `python -m picollm.accelerated.chat.sft --device-batch-size=2`
