...
from picollm.accelerated.gpt import GPT, GPTConfig, Linear
from picollm.accelerated.dataloader import tokenizing_distributed_data_loader_bos_bestfit, tokenizing_distributed_data_loader_with_state_bos_bestfit
from picollm.accelerated.common import compute_init, compute_cleanup, print0, DummyWandb, print_banner, get_base_dir, autodetect_device_type, get_peak_flops, COMPUTE_DTYPE, COMPUTE_DTYPE_REASON, is_ddp_initialized
from picollm.accelerated.tokenizer import get_tokenizer, get_token_bytes
from picollm.accelerated.checkpoint_manager import save_checkpoint, load_checkpoint
...
from picollm.accelerated.pretrain.eval import evaluate_core
print_banner()

parser = argparse.ArgumentParser(description="Pretrain base model")
parser.add_argument("--run", type=str, default="dummy", help="wandb run name ('dummy' disables wandb logging)")
parser.add_argument("--wandb-entity", type=str, default=os.environ.get("WANDB_ENTITY"), help="W&B entity/account to log runs under")
...
if not use_dummy_wandb and not args.wandb_entity:
    raise SystemExit("W&B entity is required. Set WANDB_ENTITY or pass --wandb-entity.")
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(
    project="picollm-accelerated",
