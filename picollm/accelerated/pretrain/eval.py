...
from picollm.accelerated.dataloader import tokenizing_distributed_data_loader_bos_bestfit
from picollm.accelerated.loss_eval import evaluate_bpb
from picollm.accelerated.engine import Engine


class ModelWrapper:
    """Lightweight wrapper to give HuggingFace models an accelerated-stack-compatible interface."""
...
def main():
    ...
    parser.add_argument('--model-tag', type=str, default=None, help='model tag to identify the checkpoint directory')
