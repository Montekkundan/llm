...
def get_system_info():
    ...
    info['picollm_nanochat_base_dir'] = (
        os.environ.get('PICOLLM_NANOCHAT_BASE_DIR')
        or os.environ.get('NANOCHAT_BASE_DIR')
        or 'artifacts/picollm_nanochat'
    )
...
def generate_header():
    ...
    header = f"""# picoLLM Nanochat Backend Training Report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `python -m picollm.nanochat_backend.report reset`?")
...
def get_report():
    from picollm.nanochat_backend.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset PicoLLM Nanochat backend training reports.")
