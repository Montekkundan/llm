...
import wandb
import torch
from picollm.nanochat_backend.common import compute_init, compute_cleanup, print0, DummyWandb, get_base_dir, autodetect_device_type, get_peak_flops, COMPUTE_DTYPE, COMPUTE_DTYPE_REASON, is_ddp_initialized
from picollm.nanochat_backend.tokenizer import get_token_bytes
from picollm.nanochat_backend.checkpoint_manager import save_checkpoint, load_model, load_optimizer_state
...
from picollm.nanochat_backend.scripts.chat_eval import run_chat_eval

from picollm.nanochat_backend.tasks.common import TaskMixture
from picollm.nanochat_backend.tasks.gsm8k import GSM8K
from picollm.nanochat_backend.tasks.mmlu import MMLU
from picollm.nanochat_backend.tasks.smoltalk import SmolTalk
from picollm.nanochat_backend.tasks.customjson import CustomJSON
from picollm.nanochat_backend.tasks.spellingbee import SimpleSpelling, SpellingBee
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="picollm-nanochat-sft", name=args.run, config=user_config)
